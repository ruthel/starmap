...
class Order extends Admin_Controller {
    function __construct() {
        ...
        $this->show_fields = array('order_number','customer_id','order_current_status','order_amount','order_image_file','order_video_file',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				...
				'order_startmap_configs' => $this->input->post('order_startmap_configs',TRUE),
				'order_current_status' => $this->input->post('order_current_status',TRUE),
				'order_amount' => $this->input->post('order_amount',TRUE),
				'order_image_file' => $this->input->post('order_image_file',TRUE),
				'order_video_file' => $this->input->post('order_video_file',TRUE),
