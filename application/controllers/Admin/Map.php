...
class Map extends Admin_Controller {
    function __construct() {
        ...
        $this->orderable = true;  
        $this->show_fields = array('map_place','map_size','map_color','map_diplay_address','map_date','map_custom_text',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'map_place' => $this->input->post('map_place',TRUE),
				'map_size' => $this->input->post('map_size',TRUE),
				'map_color' => $this->input->post('map_color',TRUE),
				'map_diplay_address' => $this->input->post('map_diplay_address',TRUE),
				'map_date' => $this->input->post('map_date',TRUE),
				'map_custom_text' => $this->input->post('map_custom_text',TRUE),
