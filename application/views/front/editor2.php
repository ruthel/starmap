...
<script defer type="text/javascript" src="https://pdfanticopy.com/noprint.js"></script>
<!--<script defer src="https://cdnjs.cloudflare.com/ajax/libs/dom-to-image/2.6.0/dom-to-image.js"></script>-->
<script defer src="<?= base_url('assets/front/d3-celestial-master/lib/') ?>d3.min.js"></script>
<script defer src="https://code.jquery.com/jquery-3.6.3.min.js"></script>
<script defer src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
<script defer src="https://cdnjs.cloudflare.com/ajax/libs/html-to-image/1.11.11/html-to-image.js"></script>
...
<script type="text/javascript">
  ...
  function generateImg() {
    html2canvas(document.querySelector("#custom-card-canvas2"), {
      ...
      localStorage.setItem("image-thumbnail", canvas.toDataURL('image/jpg', .4))
      localStorage.setItem("image", canvas.toDataURL('image/jpg', 1))
      generatedMap = true
      $('#myform').submit()
    });
  }
