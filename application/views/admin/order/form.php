        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('order_number','text','required',$record)?>
										 <?php echo form_item('customer_id','number','required',$record)?>
										 <?php echo form_item('order_current_status','text','not-required',$record)?>
										 <?php echo form_item('order_amount','number','not-required',$record)?>
