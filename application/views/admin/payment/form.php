        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('user_id','text','required',$record)?>
										 <?php echo form_item('product_id','text','required',$record)?>
										 <?php echo form_item('txn_id','text','required',$record)?>
										 <?php echo form_item('payment_gross','text','required',$record)?>
										 <?php echo form_item('currency_code','text','required',$record)?>
										 <?php echo form_item('payer_name','text','required',$record)?>
										 <?php echo form_item('payer_email','text','required',$record)?>
										 <?php echo form_item('payment_processing_status','text','required',$record)?>
