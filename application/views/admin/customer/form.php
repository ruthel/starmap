        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('customer_first_name','text','required',$record)?>
										 <?php echo form_item('customer_last_name','text','required',$record)?>
										 <?php echo form_item('customer_email','email','required',$record)?>
										 <?php echo form_item('customer_phone_number','number','not-required',$record)?>
										 <?php echo form_item('state_id','number','not-required',$record)?>
										 <?php echo form_item('city_id','number','not-required',$record)?>
										 <?php echo form_item('customer_street_address','textarea','not-required',$record)?>
