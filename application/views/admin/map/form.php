        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('map_place','text','required',$record)?>
										 <?php echo form_item('map_size','text','required',$record)?>
										 <?php echo form_item('map_color','text','required',$record)?>
										 <?php echo form_item('map_diplay_address','text','required',$record)?>
										 <?php echo form_item('map_date','text','required',$record)?>
										 <?php echo form_item('map_custom_text','text','required',$record)?>
